...
\section{Leadership} 
    ...
    \resumeSubHeadingListStart
                   \resumeProjectHeading
            {\textbf{{Computer Science Middle School Outreach Program}} $|$\emph{{ Founder and Directer of Instruction}}}{August 2024 -- Present}
            \\[5mm]
          \resumeItemListStart
            \resumeItem{Established \textbf{free of cost} Middle School C.S. Education Program serving\textbf{ 180+ students across 2 CFISD partner schools} (Goodson and Spillane M.S.).}
            \resumeItem{Teaching  \textbf{programming fundamentals}, and \textbf{algorithmic problem-solving} through \textbf{70+ hours} of instruction, preparing middle school students for \textbf{coding contests and college level AP C.S.} curriculum}
